...
class Events {
	...
	public static function init() {
		...
		add_action( 'save_post_aiohm_booking_event', array( __CLASS__, 'save' ) );
	}
	...
	public static function metaboxes() {
		add_meta_box( 'aiohm_booking_event', 'Event Details', array( __CLASS__, 'box' ), 'aiohm_booking_event', 'side', 'default' );
	}
