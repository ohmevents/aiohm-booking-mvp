 ...
 *
 * Handles REST API endpoints for booking operations including holds,
 * payment processing, availability checks, and webhook handling.
 *
...
class API {
	 ...
	 * @return \WP_REST_Response|\WP_Error Stripe checkout URL or error.
	 */
	 ...
	 * @since 1.0.0
	 * @param \WP_REST_Request $r REST request object.
	 * @return \WP_REST_Response Response status.
	 */
	 ...
	 * @since 1.0.0
	 * @param \WP_REST_Request $r REST request object.
	 * @return \WP_REST_Response|\WP_Error Payment capture result or error.
	 */
