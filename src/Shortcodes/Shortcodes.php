...
class Shortcodes {
	...
	public static function init() {
		add_shortcode( 'aiohm_booking_mvp', array( __CLASS__, 'sc_widget' ) );
		add_shortcode( 'aiohm_booking', array( __CLASS__, 'sc_widget' ) ); // Shorter alias
		add_shortcode( 'aiohm_booking_mvp_checkout', array( __CLASS__, 'sc_checkout' ) );
	...
	public static function assets() {
		wp_register_style( 'aiohm-booking-mvp', Assets::get_url( 'css/aiohm-booking-mvp-style.css' ), array(), AIOHM_BOOKING_MVP_VERSION );
		wp_enqueue_style( 'aiohm-booking-mvp' );
		wp_register_script( 'aiohm-booking-mvp', Assets::get_url( 'dist/js/frontend.bundle.js' ), array( 'jquery', 'wp-element' ), AIOHM_BOOKING_MVP_VERSION, true );
		wp_localize_script(
			'aiohm-booking-mvp',
			'AIOHM_BOOKING',
			array(
				...
				'i18n'         => array(
					...
					'monthNames'           => array(
						esc_html__( 'January', 'aiohm-booking-mvp' ),
						esc_html__( 'February', 'aiohm-booking-mvp' ),
						esc_html__( 'March', 'aiohm-booking-mvp' ),
						esc_html__( 'April', 'aiohm-booking-mvp' ),
						esc_html__( 'May', 'aiohm-booking-mvp' ),
						esc_html__( 'June', 'aiohm-booking-mvp' ),
						esc_html__( 'July', 'aiohm-booking-mvp' ),
						esc_html__( 'August', 'aiohm-booking-mvp' ),
						esc_html__( 'September', 'aiohm-booking-mvp' ),
						esc_html__( 'October', 'aiohm-booking-mvp' ),
						esc_html__( 'November', 'aiohm-booking-mvp' ),
						esc_html__( 'December', 'aiohm-booking-mvp' ),
					),
					'dayNames'             => array(
						esc_html_x( 'Sun', 'short day name', 'aiohm-booking-mvp' ),
						esc_html_x( 'Mon', 'short day name', 'aiohm-booking-mvp' ),
						esc_html_x( 'Tue', 'short day name', 'aiohm-booking-mvp' ),
						esc_html_x( 'Wed', 'short day name', 'aiohm-booking-mvp' ),
						esc_html_x( 'Thu', 'short day name', 'aiohm-booking-mvp' ),
						esc_html_x( 'Fri', 'short day name', 'aiohm-booking-mvp' ),
	 ...
	 */
	public static function sc_widget( $atts = array() ) {
		$atts = shortcode_atts(
			array(
	...
	public static function sc_checkout( $atts = array() ) {
		...
		ob_start();
		include AIOHM_BOOKING_MVP_DIR . 'templates/aiohm-booking-mvp-checkout.php';
		return ob_get_clean();
	}
}
