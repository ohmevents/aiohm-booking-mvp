            ...
            <div class="selected-dates-info">
              <div class="form-row form-row-3">
                <div class="input-group">
                  <label class="input-label"><?php esc_html_e('Check-in Date', 'aiohm-booking-mvp'); ?></label>
                  <input type="date" name="checkin_date" id="checkinDisplay" readonly class="form-input date-display">
                </div>
                <div class="input-group">
...
<?php echo esc_html($singular); ?> Selection
            ...
            <div class="input-group">
                <label class="input-label">
                    <?php esc_html_e('Select one or more options. Prices are per night.', 'aiohm-booking-mvp'); ?>
                </label>
        ...
        <div class="form-section">
          ...
          <div class="form-row form-row-2">
            ...
            <?php $is_visible = !empty($opts['form_field_purpose']); ?>
            <div class="input-group purpose-field" <?php if (!$is_visible) echo 'style="display: none;"'; ?>>
              <label class="input-label" for="purpose-of-stay"><?php esc_html_e('Purpose of Stay', 'aiohm-booking-mvp'); ?></label>
              <select name="purpose_of_stay" id="purpose-of-stay" class="form-input">
                <option value="leisure"><?php esc_html_e('Leisure / Vacation', 'aiohm-booking-mvp'); ?></option>
                <option value="business"><?php esc_html_e('Business / Work', 'aiohm-booking-mvp'); ?></option>
                <option value="event"><?php esc_html_e('Event / Retreat', 'aiohm-booking-mvp'); ?></option>
          ...
          <?php $is_visible = !empty($opts['form_field_address']); ?>
          <div class="form-row address-field" <?php if (!$is_visible) echo 'style="display: none;"'; ?>>
            <div class="input-group">
          ...
          <?php $is_visible = !empty($opts['form_field_country']); ?>
          <div class="form-row country-field" <?php if (!$is_visible) echo 'style="display: none;"'; ?>>
            <div class="input-group">
              <label class="input-label">Country</label>
              <input type="text" name="country" class="form-input" placeholder="Enter your country">
            </div>
          </div>

          <div class="form-row form-row-2">
            <?php $is_visible = !empty($opts['form_field_age']); ?>
            <?php $min_age = intval($opts['min_age'] ?? 0); ?>
            <div class="input-group age-field" <?php if (!$is_visible) echo 'style="display: none;"'; ?>>
              <label class="input-label">Age<?php if ($min_age > 0) echo ' (minimum ' . esc_html($min_age) . ')'; ?><?php if ($is_visible) echo ' *'; ?></label>
              <input type="number" name="age" <?php if ($is_visible) echo 'required'; ?> <?php if ($min_age > 0) echo 'min="' . esc_attr($min_age) . '"'; ?> max="99" class="form-input" placeholder="Enter your age<?php if ($min_age > 0) echo ' (minimum ' . esc_attr($min_age) . ')'; ?>">
            </div>

            <?php $is_visible = !empty($opts['form_field_vat']); ?>
            <div class="input-group vat-field" <?php if (!$is_visible) echo 'style="display: none;"'; ?>>
              <label class="input-label" for="vat-number"><?php esc_html_e('VAT Number', 'aiohm-booking-mvp'); ?></label>
              <input type="text" name="vat_number" id="vat-number" class="form-input" 
                     placeholder="<?php esc_attr_e('For business invoices', 'aiohm-booking-mvp'); ?>">
            </div>

            <?php $is_visible = !empty($opts['form_field_company']); ?>
            <div class="input-group company-field" <?php if (!$is_visible) echo 'style="display: none;"'; ?>>
            ...
            <div class="price-row earlybird-row aiohm-hidden">
              <span class="price-label"><?php
                if (!empty($earlybird_days) && $earlybird_days > 0) {
                  ...
                  printf(esc_html__('Early Bird (%d days):', 'aiohm-booking-mvp'), $earlybird_days);
                } else {
